...
-- -----------------------------------------------------
-- Table `mi151_00_master_db`.`employee6`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mi151_00_master_db`.`employee6` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `mi151_00_master_db`.`attendee` (
  ...
  `employee_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_attendee_employee1_idx` (`employee_id` ASC),
  CONSTRAINT `fk_attendee_employee1`
    FOREIGN KEY (`employee_id`)
    REFERENCES `mi151_00_master_db`.`employee6` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mi151_00_master_db`.`feedback` (
  ...
  INDEX `fk_feedback_employee1_idx` (`employee_id` ASC),
...
-- -----------------------------------------------------
-- Table `mi151_00_master_db`.`room4`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mi151_00_master_db`.`room4` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `mi151_00_master_db`.`event_has_room` (
  ...
  CONSTRAINT `fk_event_has_room_room1`
    FOREIGN KEY (`room_id`)
    REFERENCES `mi151_00_master_db`.`room4` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = euckr;
